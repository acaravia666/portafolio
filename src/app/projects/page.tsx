    ...
    <main className="flex-grow flex flex-col pt-20">
      ...
      <section className="border-b border-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 border-t border-black">
          {/* SERVICE_01 — large, fully clickable */}
          <AnimatedBlock
            delay={0}
          ...
          >
            ...
            <Link href="/projects/web-engineering" className="relative z-10 p-8 md:p-12 flex flex-col h-full">
              ...
              <div className="mt-auto pt-16 flex justify-between items-end border-t border-white/20">
                ...
                <span className="material-symbols-outlined text-4xl text-gray-500 group-hover:text-secondary-container transition-colors">
                  arrow_forward
                </span>
              </div>
            </Link>
